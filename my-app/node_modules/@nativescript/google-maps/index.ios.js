...
var GMSMapViewDelegateImpl = /** @class */ (function (_super) {
    ...
    GMSMapViewDelegateImpl.prototype.mapViewMarkerInfoContents = function (mapView, marker) {
        ...
        var event = {
            ...
            object: (_b = (_a = this._owner) === null || _a === void 0 ? void 0 : _a.get) === null || _b === void 0 ? void 0 : _b.call(_a),
            marker: Marker.fromNative(marker),
            view: null,
        };
        (_f = (_d = (_c = this._owner) === null || _c === void 0 ? void 0 : _c.get) === null || _d === void 0 ? void 0 : (_e = _d.call(_c)).notify) === null || _f === void 0 ? void 0 : _f.call(_e, event);
