...
export class LocalizationUtils extends LocalizationUtilsBase {
    ...
    static createNativeDateFormatter(formatPattern, nativeLocale) {
        ...
        if (!formatPattern) {
            dateFormatter.dateStyle = 2 /* NSDateFormatterStyle.MediumStyle */;
            dateFormatter.timeStyle = 0 /* NSDateFormatterStyle.NoStyle */;
        }
        else {
    ...
    static createNativeTimeFormatter(formatPattern, nativeLocale) {
        ...
        dateFormatter.locale = nativeLocale;
        if (!formatPattern) {
            dateFormatter.dateStyle = 0 /* NSDateFormatterStyle.NoStyle */;
            dateFormatter.timeStyle = 1 /* NSDateFormatterStyle.ShortStyle */;
        }
        else {
            dateFormatter.dateFormat = formatPattern;
        }
