...
function initializeDialogListener() {
    ...
    var DialogListenerImpl = /** @class */ (function (_super) {
...
export class DateTimePicker extends DateTimePickerBase {
    static pickDate(options, style) {
        const pickDate = new Promise((resolve) => {
            ...
            const nativeDialogBuilder = DateTimePicker._createNativeDialog(nativeDatePicker, options, options.date, (result) => {
                if (originalLocale) {
    ...
    static pickTime(options, style) {
        const pickTime = new Promise((resolve) => {
            ...
            const nativeDialogBuilder = DateTimePicker._createNativeDialog(nativeTimePicker, options, options.time, (result) => {
                if (originalLocale) {
...
DateTimePicker._nativeDialog = null;
