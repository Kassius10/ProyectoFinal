...
export class DateTimePicker extends DateTimePickerBase {
    ...
    static _createNativeDatePicker(options) {
        ...
        pickerView.datePickerMode = 1 /* UIDatePickerMode.Date */;
    ...
    static _createNativeTimePicker(options) {
        const pickerView = UIDatePicker.alloc().initWithFrame(CGRectZero);
        pickerView.datePickerMode = 0 /* UIDatePickerMode.Time */;
    ...
    static _createNativeDialog(nativePicker, options, style, callback) {
        ...
        const alertController = UIAlertController.alertControllerWithTitleMessagePreferredStyle(alertTitle, DateTimePicker.PICKER_DEFAULT_MESSAGE, 0 /* UIAlertControllerStyle.ActionSheet */);
        ...
        const pickerViewWidth = UIDevice.currentDevice.userInterfaceIdiom === 1 /* UIUserInterfaceIdiom.Pad */ ? DateTimePicker.PICKER_WIDTH_PAD : alertSize - DateTimePicker.PICKER_WIDTH_INSETS;
        ...
        const cancelActionStyle = style && style.buttonCancelBackgroundColor ? 0 /* UIAlertActionStyle.Default */ : 1 /* UIAlertActionStyle.Cancel */;
        let cancelAction = UIAlertAction.actionWithTitleStyleHandler(cancelButtonText, cancelActionStyle, () => {
            callback(null);
        });
        let okAction = UIAlertAction.actionWithTitleStyleHandler(okButtonText, 0 /* UIAlertActionStyle.Default */, () => {
...
DateTimePicker._isTablet = Device.deviceType === 'Tablet';
